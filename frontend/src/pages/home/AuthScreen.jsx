...
const AuthScreen = () => {
  ...
  return <div className='hero-bg relative'>
      ...
      {/*hero sectio */}
       ...
       <div className='h-2 w-full bg-[#232323]' aria-hidden='true'/>{/* separator*/}
       {/* 1st section*/}
       ...
       <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
        ...
        {/*right*/}
        <div className='flex-1 md:text-xl text-center'>
                    <h2 className='text-4xl md:text-5xl font-extrabold mb-4'> Dowload your shows to watch online</h2>
                    <p className='text-lg md:text-xl'>
       ...
       <div className='py-10 bg-black text-white'>
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                {/* left*/}
                <div className=' flex-1 text-center md:text-left '>
                    <h2 className='text-4xl md:text-5xl font-extrabold mb-4'> Watch Evrywhere</h2>
                    <p className='text-lg md:text-xl'>
                        Stream Unlimited Movies and Tv Shows on your Laptop, Phone, Tablet, and Tv.
                    </p>
                </div>
                {/* right side */}
       ...
       <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
            {/* left ride */}
            <div className='flex-1 relative'>
                <img src='/kids.png' alt='kids image' className='mt-4' ></img>
            </div>
            {/* right ride */}
            <div className='flex-1 text-center md:text-left'>
            <h2 className='text-4xl font-extrabold mb-4 md:text-5xl'> Create profile for kids</h2>
            <p1 className='text-lg md:text-xl'>Send kids adventures with their favorite characters in a space made just for them-free with your membership</p1>
            </div>
        </div>
        </div>
